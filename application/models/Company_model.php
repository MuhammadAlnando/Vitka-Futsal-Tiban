...
public function get_company_name() {
  $this->db->select('company_name'); // 'name' adalah kolom yang menyimpan nama perusahaan
  $this->db->from('company'); // 'company' adalah nama tabel yang menyimpan data perusahaan
  $query = $this->db->get();
  if ($query->num_rows() > 0) {
