                        ...
                        <?php $start = 0; foreach ($users as $user):?>
                          <tr>
                            ...
                            <td style="text-align:center"><?php if(!empty($user->last_login)){echo date("Y-m-d H:i:s", $user->last_login);} ?></td>
                              ...
                              <td style="text-align:center"><?php echo ($user->active) ? anchor("admin/auth/deactivate/".$user->id, 'Aktif','title="ACTIVE", class="btn btn-sm btn-primary"', lang('index_active_link')) : anchor("admin/auth/activate/". $user->id, 'Tidak Aktif','title="INACTIVE", class="btn btn-sm btn-danger"' , lang('index_inactive_link'));?></td>
