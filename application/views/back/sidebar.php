        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url() ?>" target="_blank">
                    <span>&#x1F30E;</span> <span>Jelajahi Website</span>
                </a>
            </li>
            ...
            <li class="treeview <?php if ($this->uri->segment(2) == "event") {
                ...
                <a href='#'>
                    <span>&#x1F4D4;</span><span> Transaksi </span><i class='fa fa-angle-left pull-right'></i>
                </a>
                <ul class='treeview-menu'>
                    ...
                    <?php if ($this->ion_auth->is_superadmin()) : ?>
                        <li <?php if ($this->uri->segment(2) == "bank" && $this->uri->segment(3) == "") {
                                echo "class='active'";
                            } ?>>
            ...
            <li class="treeview <?php if ($this->uri->segment(2) == "event") {
                ...
                <a href='#'>
                    <span>&#x1F4E7;</span><span> Pesan </span><i class='fa fa-angle-left pull-right'></i>
                </a>
                <ul class='treeview-menu'>
                    <?php if ($this->ion_auth->is_superadmin()) : ?>
                    ...
                    <?php endif ?>
                    <?php if ($this->ion_auth->is_superadmin()) : ?>
                        <li <?php if ($this->uri->segment(2) == "pesan") {
                                echo "class='active'";
                            } ?>>
            ...
            <?php if ($this->ion_auth->is_superadmin()) : ?>
                <li <?php if ($this->uri->segment(2) == "company" && $this->uri->segment(3) == "") {
                        echo "class='active'";
                    } ?>><a href='<?php echo base_url() ?>admin/company/update/1'> <span>&#x1F3E2;</span> <span>Profil Perusahaan</span> </a> </li>
            <?php endif ?>
            <?php if ($this->ion_auth->is_superadmin()) : ?>
