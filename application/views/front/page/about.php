...
<div class="container">
    <h2 class="mt-4 mb-4">TENTANG KAMI</h2>
    <hr>
    ...
    <div class="row">
        <div class="col-md-8 text-center mb-4">
            ...
            <?php else : ?>
                <img src="<?php echo base_url('assets/images/company/' . $company->foto . $company->foto_type) ?>" class="img-fluid" alt="<?php echo $company->company_name ?>" style="max-width: 500px; height: auto; margin: 0 0 40px 0;">
            <?php endif; ?>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title" style="text-align: left;">Tentang <?php echo $company->company_name ?></h5>
